...
{     
     ...
     #echo "Nome item atual: ".$itemAutal. "</br>";
       $exclusaoResult  = $fachada->excluirShield($itemAutal); 
       if ($exclusaoResult == 1) {
...
$arrayResult  = $fachada->exibirShieldPorCategoria($ID_ItemAtual);
        ...
        ?>
          ...
          <div class="row" align="start">
            ...
            <div class="col-md-6 mr-4 ml-5">
              <form method="POST" action="TelaExibirShield.php" data-toggle="validator" role="form" align="center" >
            ...
            <div class="col-md-1 ml-0 mr-2" align="end">
              <form  class="" method="POST" action="TelaEditarShield.php" data-toggle="validator" role="form">
                  <input type="hidden" name="ItemPesquisa" id="cod_processo" value="<?php echo $row['ID_Item']; ?>"/> 
        ...
        <div class="modal fade" id="ID_Modal_Excluir" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true" >
                  <div class="modal-dialog" role="document">
                    <div class="modal-content"  >
                      ...
                      <form method="POST" action="TelaGerenciarShields.php" >
