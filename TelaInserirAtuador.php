...
<!--   =============================Início do corpo cipal =================================  -->
 ...
 <h5 class="modal-title mb-3 mt-4" align="center"><b>Inserir Atuador</b></h5>
  <!--   
   <div class="form-row"> 
   ...
   -->
     ...
     <div class="container-fluid  d-flex flex-column bd-highlight  quadradoInserirShield  col-md-10" data-spy="scroll"  data-target="#list-example" data-offset="0" class="scrollspy-example">
      ...
      <div class="container-fluid  align-items-center ">
       <form  class="tamnhoForm" method="POST" action="ControleAtuador.php" role="form" enctype="multipart/form-data" data-toggle="validator">
...
<!--   ====================== Carregamento das imagens ==================================   -->
         <div class="form-row" align="start">
           ...
           <div class="form-group col-md-5" align="start">
             ...
             <img src="img/atuadorIcon.png" id="ID_IMG_Componente"  class="img mt- border border-primary rounded" width="130" height="80">
           ...
           <div class="form-row">
             <div class="form-group col-md-4" align="start">
              ...
              <div class="form-group col-md-4" align="start">
               ...
               <select name="cor" id="inputState" class="form-control">
                 <option selected>RBG</option>
...
<!--   =============================== Linha 3 =================================   -->
         ...
         <div class="form-row">
             <div class="form-group col-md-4" align="start">
               ...
               <input type="link" name="controlador" class="form-control" id="ID_Campo_Controlador" placeholder="">
             </div>
             <div class="form-group col-md-4" align="start">
