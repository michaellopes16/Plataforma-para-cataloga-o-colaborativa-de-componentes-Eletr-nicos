...
{     
     ...
     #echo "Nome item atual: ".$itemAutal. "</br>";
       $exclusaoResult  = $fachada->excluirBateria($itemAutal); 
       if ($exclusaoResult == 1) {
...
$arrayResult  = $fachada->exibirBateriaPorCategoria($ID_ItemAtual);
                ...
                <div class="modal fade" id="ID_Modal_Excluir" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true" >
                  <div class="modal-dialog" role="document">
                    <div class="modal-content"  >
                      ...
                      <form method="POST" action="TelaGerenciarBaterias.php" >
