...
<!--   ==================== Início do corpo principal=======================================   -->
 ...
 <h5 class="modal-title mb-3 mt-4" align="center"><b>Editar Informações do Microcontrolador</b></h5>
  <!--   
   <div class="form-row"> 
 ...
 <!--   =============================   Informações Gerais   ============================================   -->
        ...
        <!--   ====================== Carregamento das imagens =========================================   -->
         ...
         <div class="form-row" align="start">
           ...
           <div class="form-group col-md-5" align="start">
             <img src="img/pinagem.png" id="ID_IMG_Componente"  class="img mt- border border-primary  rounded" width="130" height="80">
             <input type="file" class="form-control-file" id="ID_Enviar_Pinagem">
         ...
         <div class="form-row" align="center">
           <div class="form-group col-md-4" align="start">
             ...
             <input type="text" class="form-control" id="ID_Campo_Nome" placeholder="Ex.: Arduino">
           </div>
           <div class="form-group col-md-4" align="start">
             <label for="ID_Campor_Modelo">Modelo</label>
             <input type="text" class="form-control" id="ID_Campor_Modelo" placeholder="Ex.: Uno R3">
           </div>
           <div class="form-group col-md-4" align="start">
         ...
         <div class="form-row">
           ...
           <div class="form-group col-md-4" align="start">
             <label for="ID_Site_Fabri">Site do Fabricante</label>
             <input type="link" class="form-control" id="ID_Site_Fabri" placeholder="https:// ...">
           </div>
           <div class="form-group col-md-4" align="start">
         ...
         <div class="form-row">
           ...
           <div class="form-group col-md-4" align="start">
             ...
             <select id="inputState" multiple class="form-control">
 ...
 <!--   =============================   Informações Técnicnas   ============================================   -->       
       ...
       <div class="form-row">
         <div class="form-group col-md-4" align="start">
           ...
           <input type="text" class="form-control" id="ID_Processador" placeholder="">
         </div>
         <div class="form-group col-md-4" align="start">
           <label for="ID_Memoria_Ram" >Memória RAM</label>
           <input type="text" class="form-control" id="ID_Memoria_Ram" placeholder="">
         </div>
         <div class="form-group col-md-4" align="start">
           <label for="ID_Memoria_Flash">Memória Flash</label>
           <input type="text" class="form-control" id="ID_Memoria_Flash" placeholder="">
         </div>
       </div>
       <div class="form-row">
         <div class="form-group col-md-4" align="start">
           <label for="ID_Microcontro">Microcontrolador</label>
           <input type="text" class="form-control" id="ID_Microcontro" placeholder="">
         </div>
         <div class="form-group col-md-4" align="start">
           <label for="ID_Clock">Velocidade de Clock</label>
           <input type="text" class="form-control" id="ID_Clock" placeholder="">
         </div>
         <div class="form-group col-md-2" align="start">
           <label for="ID_GPIO_A">GPIO- Analógicas</label>
           <input type="number" class="form-control" id="ID_GPIO_A" placeholder="Nº">
         </div>
         <div class="form-group col-md-2" align="start">
           <label for="ID_GPIO_D">GPIO- Digitais</label>
           <input type="number" class="form-control" id="ID_GPIO_D" placeholder="Nº">
         </div>
       </div>
      ...
      <h4 class="mt-4 mb-4  border border-primary border-top-0 border-right-0 rounded text-primary" id="list-item-3" align="start">Informações Elétricas</h4>
       ...
       <div class="form-row">
         <div class="form-group col-md-4" align="start">
           ...
           <input type="text" class="form-control" id="ID_Tensao_Ope" placeholder="Em voltes">
         </div>
         <div class="form-group col-md-4" align="start">
           <label for="ID_Tensao_Entr">Tensão de Entrada</label>
           <input type="text" class="form-control" id="ID_Tensao_Entr" placeholder="Em voltes">
         </div>
         <div class="form-group col-md-4" align="start">
...
<!--   =============================   Interfaces de Comunicação   =========================================   -->       
       ...
       <div class="form-row">
           ...
           <div class="form-group col-md-4" align="start">
             ...
             <select id="ID_Comu_SF" multiple class="form-control">
           ...
           <div class="form-group col-md-4" align="start">
             ...
             <select id="ID_Comu_Se" multiple class="form-control">
               <option selected>Nenhuma</option>
               <option>I2C</option>
               <option>UART</option>
             </select>
...
<!--   =============================   Componentes Adicionais   =========================================   -->              
       ...
       <div class="form-row">
         <div class="form-group col-md-4" align="start">
          <!-- Tem que ser uma Lista de multipla escolha -->
           ...
           <select id="ID_Inter_E" multiple class="form-control">
         ...
         <div class="form-group col-md-4" align="start">
          <!-- Tem que ser uma Lista de multipla escolha -->
           ...
           <select id="ID_Sensores" multiple class="form-control">
             <option selected>Nenhum</option>
       ...
       <div class="form-group" align="start">
           ...
           <textarea class="form-control" id="ID_Campo_Ind_Add" rows="8" style="resize: none" placeholder="Digite aqui alguma informação sobre o componete que não está em um dos campos acima..."></textarea>
      </div>

<!--   =============================   Botão Salvar  =========================================   -->                
     <a href="TelaInserirMicrocontrolador.php" class="btn btn-primary mt-5 mb-3 ml-4" align="center">
