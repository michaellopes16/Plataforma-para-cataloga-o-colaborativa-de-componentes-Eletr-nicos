...
<!--   =============================Início do corpo cipal =================================  -->
 ...
 <h5 class="modal-title mb-3 mt-4" align="center"><b>Inserir Shield</b></h5>
  <!--   
   <div class="form-row"> 
   ...
   -->
     ...
     <div class="container-fluid  d-flex flex-column bd-highlight  quadradoInserirShield  col-md-10" data-spy="scroll"  data-target="#list-example" data-offset="0" class="scrollspy-example">
      ...
      <div class="container-fluid  align-items-center ">
       <form  class="tamnhoForm" method="POST" action="ControleShield.php" role="form" enctype="multipart/form-data" data-toggle="validator">
...
<!--   ====================== Carregamento das imagens ==================================   -->
         <div class="form-row" align="start">
           ...
           <div class="form-group col-md-5" align="start">
             ...
             <img src="img/shieldIcon.png" id="ID_IMG_Componente"  class="img mt- border border-primary rounded" width="130" height="80">
...
<!--   =============================== Linha 1 =========================================   -->
         ...
         <div class="form-row">
           <div class="form-group col-md-4" align="start">
             ...
             <input type="text" name="funcao" class="form-control" id="ID_Campo_Funcao" placeholder="">
           </div>
                 ...
                 <div  id="e_compativel" class="divScrolComp rounded" data-spy="scroll" data-offse="0">
                       ...
                       <li class="list-group-item list-group-item-primary d-flex bd-highlight mt-2 mr-2 rounded" style="height: 60px;">
                         ...
                         <?php  
                              endforeach;  
                        ?>
                       <!-- Fazer parecedio com a listagem do gerenciar componentes: Guardar os IDs do microcontroladores compatíveis  -->
