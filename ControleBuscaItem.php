...
$arrayResult  = $fachada->getItens($idItem);
...
if($countBusca <=0 || $idItem == "" )
    {
          ...
          if(!isset($_POST["ID_Item"]) && !isset($_POST["ID_Excluir"]) && !isset($_POST["ID_Fechar"]) && !isset($_POST["ID_TirarDaLista"])){
           echo '<li class="list-group-item list-group-item-primary d-flex bd-highlight mt-2 ml-2 mb-2 mr-2 rounded" style="height: 60px;"> 
