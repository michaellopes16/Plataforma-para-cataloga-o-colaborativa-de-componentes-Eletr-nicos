...
.form-control:focus {
  ...
  border-color: silver;
  outline: none;
  box-shadow: inset 0 1px 1px rgba(0, 0, 0, 0.075), 0 0 0 0.2rem rgba(128, 128, 128, 0.25);
}
...
.btn:not([disabled]):not(.disabled):active, .btn:not([disabled]):not(.disabled).active {
  background-image: none;
  box-shadow: 0 0 0 0.2rem rgba(128, 128, 128, 0.25), inset 0 3px 5px rgba(0, 0, 0, 0.125);
}
...
.custom-select:focus {
  border-color: silver;
  outline: none;
  box-shadow: inset 0 1px 2px rgba(0, 0, 0, 0.075), 0 0 5px rgba(192, 192, 192, 0.5);
}
...
.custom-file-input:focus ~ .custom-file-control {
  box-shadow: 0 0 0 0.075rem #fff, 0 0 0 0.2rem #808080;
}
