...
<!--   ==================== Início do corpo principal=======================================   -->
 ...
 <h5 class="modal-title mb-3 mt-4" align="center"><b>Editar Informações do Projeto</b></h5>
     ...
     <div class="container-fluid  d-flex flex-column bd-highlight  quadradoInserirProjeto  col-md-10" data-spy="scroll"  data-target="#list-example" data-offset="0" class="scrollspy-example">
      ...
      <div class="container-fluid  align-items-center ">
       <form  class="tamnhoForm" method="POST" action="ControleProjetoUpdate.php" role="form" enctype="multipart/form-data" data-toggle="validator">
        ...
        <!--   ====================== Carregamento das imagens =========================================   -->
         ...
         <div class="form-row" align="start">
           ...
           <div class="form-group col-md-5" align="start">
             ...
             <img src="<?php echo $arrayResult['img_projeto']; ?>" id="ID_IMG_Projeto"  class="img mt- border border-primary rounded" width="130" height="80">
         ...
         <div class="form-row" align="center">
           <div class="form-group col-md-6" align="start">
             ...
             <input type="text" name="nome" class="form-control" value="<?php echo $arrayResult['nome']; ?>" id="ID_Campo_Nome" placeholder="Título">
           </div>
           ...
           <div class="form-group col-md-6" align="start">
             ...
             <input type="text" name="autor_principal" class="form-control" value="<?php echo $arrayResult['autor_principal']; ?> " id="ID_Campo_Nome_autorP" placeholder="Nome Completo">
           </div>
         </div>
          <!--   =============================== Linha 2 =========================================   -->
         <div class="form-row">
          <div class="form-group col-md-6" align="start">
            ...
            <input type="email" name="email_autor_principal" value="<?php echo $arrayResult['email_autor_principal'] ?>" class="form-control" id="ID_Campo_Email_autorP" placeholder="fulano@beltrano.com.br">
          </div>
           <div class="form-group col-md-6" align="start">
             <label for="ID_Campo_Nome_demaisA">Nome demais autores</label>
             <input type="text" name="nome_demais_autores" value="<?php echo $arrayResult['nome_demais_autores'] ?>" class="form-control" id="ID_Campo_Nome_demaisA" placeholder="Fulano de Sá, Beltrano Lopes...">
           </div>
         </div>
   ...
   <!--   =============================== Linha 3 =========================================   -->   
      <div class="form-row">
         <div class="form-group col-md-6" align="start">
           ...
           <input type="text" value="<?php echo $arrayResult['email_demais_autores'] ?>" name="email_demais_autores" class="form-control" id="ID_Campo_Email_demaisA" placeholder="fulano@beltrano.com, lopes@santos.com,...">
         </div>
         <div class="form-group col-md-6" align="start">
           <label for="ID_campo_Palavra_Chave">Palavras Chave para o projeto</label>
           <input type="text" value="<?php echo $arrayResult['palavra_chave'] ?>" name="palavra_chave" class="form-control" id="ID_campo_Palavra_Chave" placeholder="Projeto Tal, Tecnologia Tal, Placa tal...">
         </div>
      </div>
   <!--   =============================== Linha 4 =========================================   -->
         ...
         <div class="form-row">
          <div class="form-group col-md-6" align="start">
            ...
            <input type="link" name="link_repo" value="<?php echo $arrayResult['link_repo']; ?>" class="form-control" id="ID_Campo_Repositorio" placeholder="https:// ...">
          </div>
          <div class="form-group col-md-6" align="start">
            <label for="ID_Campo_Video">Link para vídeo Demonstrativo</label>
            <input type="link" name="link_video" value="<?php echo $arrayResult['link_video']; ?>" class="form-control" id="ID_Campo_Video" placeholder="https:// ...">
          </div>
         </div>
     <!--   =============================== Linha 5 =========================================   -->      
         <div class="form-row">
          <div class="form-group col-md-6" align="start">
            ...
            <input type="link" name="link_site" value="<?php echo $arrayResult['link_site']; ?>"class="form-control" id="ID_Campo_Repositorio" placeholder="https:// ...">
          </div>
         </div>     
 ...
 <!--   =============================   Metodologia Utilizada   ============================================   -->       
       ...
       <div class="form-group" align="start">
           <textarea class="form-control" name="metodologia" id="ID_Campo_Ind_Add" rows="16" style="resize: none" placeholder="Descreva o passo a passo para construção do seu projeto.">  <?php echo $arrayResult['metodologia'] ?></textarea>
      </div>
  <!--   =============================   Componentes Utilizados   ============================================   -->       
    ...
    <div class="form-row">
           ...
           <?php if(isset($_SESSION['ID_Projeto'])) {?>
            <input type="hidden" name="compativel[]" value="<?php $_SESSION['ID_Projeto'];?> "/>
          <?php } ?>
             ...
             <div class="form-group col-md-4" align="start">
                  ...
                  <div  id="e_compativel" class="divScrollItens rounded" data-spy="scroll" data-offse="0">
                    ...
                    $novoArrayNome = array();
                    $novoArrayID = array();
                    #echo"Tela Editar: quant ID_Item: ".count($_SESSION['ID_Item'])." - NomeItem".count($_SESSION['Nome_Item']);  
                  ...
                  ?>
                      <li class="list-group-item list-group-item-primary d-flex bd-highlight mt-2 mr-2 rounded" style="height: 60px;">
                         ...
                         <a href="#" id="<?php echo $row['ID_Item'] ?>" class="btn btn-danger mt-0 mr-0 ml-2"  data-toggle="modal" data-target="#ID_Modal_Excluir_Item">  
                          ...
                          <?php  
                           } mysqli_free_result($resultCompativel);
                         ?>
                   </div>
               </div>
         </div>
