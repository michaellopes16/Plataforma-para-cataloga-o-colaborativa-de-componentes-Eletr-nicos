...
<!--   =============================Início do corpo principal=======================================   -->
 ...
 <h5 class="modal-title mb-3 mt-4" align="center"><b>Editar Informações do Atuador</b></h5>
  <!--   
   <div class="form-row"> 
   ...
   -->
     ...
     <div class="container-fluid  d-flex flex-column bd-highlight  quadradoInserirShield  col-md-10" data-spy="scroll"  data-target="#list-example" data-offset="0" class="scrollspy-example">
      ...
      <div class="container-fluid  align-items-center ">
       <form  class="tamnhoForm" method="POST" action="ControleAtuadorUpdate.php" role="form" enctype="multipart/form-data" data-toggle="validator">
         ...
         <div class="form-row">
            <div class="form-group col-md-4" align="start">
             <label for="inputState">Cor</label>
              ...
              <?php 
              echo "COR: ".$arrayResult['cor'];
       $cores =array("--","RBG","Amarelo","Azul","Branco","Verde","Vermelho","Laranja","Rosa","Ultra Violeta","Outra");
              ?> 
             <select id="inputState" name="cor" class="form-control">
             <?php foreach ($cores as $cor)
              {
                 if($cor == $arrayResult['cor'])
             ...
             <div class="form-group col-md-4" align="start">
               <label for="ID_Campo_Controlador" >Controlador</label>
               <input type="link" name="controlador" class="form-control" value="<?php echo $arrayResult['controlador']; ?>" id="ID_Campo_Controlador" placeholder="">
             </div>
         </div>
         <!--   =============================== Linha 4 =========================================   -->
         <div class="form-row">
