...
$itemAtual = $_SESSION["nomeUser"] ;

$fachada = new Fachada;
#$micro = new MicrocontroladorVO;

$arrayResult  = $fachada->exibirMicroPorCategoria($itemAtual);
          ...
          <div class="row" align="start">
            ...
            <div class="col-md-1 ml-0 mr-2" align="end">
             ...
             <div class="col-md-1 ml-3" align="center">
              <button class="btn btn-danger mt-3 tamanhoBTNS" data-toggle="modal" data-target="#ID_Modal_Excluir">  
                      ...
                      <div class="modal-body">
                        <form>
                          <div class="form-group">
                            <label for="recipient-name" class="col-form-label">Tem certeza que deseja excluir o Componente?</label>
                          </div>
                        </form>
                      </div>
