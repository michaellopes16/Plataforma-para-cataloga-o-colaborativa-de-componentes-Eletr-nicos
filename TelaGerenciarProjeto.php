...
{     
     ...
     #echo "Nome item atual: ".$itemAutal. "</br>";
       $exclusaoResult  = $fachada->excluirProjeto($itemAutal); 
       if ($exclusaoResult == 1) {
...
$arrayResult  = $fachada->exibirProjetoPorUsuario($nomeUser);
...
?>
  <h5 class="modal-title mb-3 mt-4" align="center"><b>Gerenciar Projetos</b></h5>
        ...
        ?>
          ...
          <div class="row" align="start">
            <div class="col-md-2.5 ml-2 ">     
                  ...
                  <img src="<?php echo  $row['img_projeto']; ?>" 
                  class="img mt-1 ml-2" align="center" width="90" height="65">
            </div>

            <div class="col-md-6 mr-4 ml-5">
              <form method="POST" action="TelaExibirProjeto.php" data-toggle="validator" role="form" align="center" >
                <input type="hidden" name="ItemPesquisa" id="cod_processo" value="<?php echo $row['ID_Projeto']; ?>"/> 
                   <button  type="submit" class="btn btn-outline-primary  mb-1 mt-2 border-0 ">  
                      <h6 style="text-align:center;">
                        <p>
                        <?php echo  "<b>Nome Projeto:</b> ".$row['nome']."</br> <b> Autor Principal: </b>". $row['autor_principal'];?> 
                       </p>
                     </h6> 
                    </button>
              </form>
            ...
            <div class="col-md-1 ml-0 mr-2" align="end">
              <form  class="" method="POST" action="TelaEditarProjeto.php" data-toggle="validator" role="form">
                  <input type="hidden" name="ItemPesquisa" id="cod_processo" value="<?php echo $row['ID_Projeto']; ?>"/> 
             ...
             <div class="col-md-1 ml-3" align="center">
              ...
              <button class="btn btn-danger mt-3 tamanhoBTNS" data-toggle="modal" data-target="#ID_Modal_Excluir" action="<?php $ID_ItemAtual = $row['ID_Projeto']; $itemAutal =  $row; ?>">  
        ...
        <div class="modal fade" id="ID_Modal_Excluir" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true" >
             <div class="modal-dialog" role="document">
                  <div class="modal-content"  >
                      ...
                      <div class="modal-body">
                        <form>
                          <div class="form-group">
                            <label for="recipient-name" class="col-form-label">Tem certeza que deseja excluir o Componente <?php echo $itemAutal['nome']?>?</label>
                          </div>
                        </form>
                      </div>
                      ...
                      <form method="POST" action="TelaGerenciarProjeto.php" >
