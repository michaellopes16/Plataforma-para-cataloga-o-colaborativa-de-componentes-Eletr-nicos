...
$arrayResult  = $fachada->exibirShield($idItem);
...
<!--   ==================== Início do corpo principal=======================================   -->
 ...
 <h5 class="modal-title mb-3 mt-4" align="center"><b>Editar Informações do Shield</b></h5>
  <!--   
   <div class="form-row"> 
   ...
   -->
    ...
    <div class="container-fluid  align-items-center ">
       <form  class="tamnhoForm" method="POST" action="ControleShieldUpdate.php" role="form" enctype="multipart/form-data" data-toggle="validator">
...
<!--  ====================== Carregamento das imagens =========================================   -->
          ...
          <!--   =============================== Linha 2 =========================================   -->
           ...
           <div class="form-row">
            ...
            <div class="form-group col-md-4" align="start">
              ...
              <input type="link" class="form-control" name="peso"value="<?php echo $arrayResult['peso']; ?>" id="ID_Campo_Peso" placeholder="20 gm">
            </div>
              <div class="form-group col-md-4" align="start">
         ...
         <div class="form-row">
           <div class="form-group col-md-4" align="start">
             ...
             <input type="text" class="form-control" name="funcao" value="<?php echo $arrayResult['funcao']; ?>" id="ID_Campo_Funcao" placeholder="">
           </div>
           
          
           <!-- Ver como listar isso   <?php echo $arrayResult['compativel']; ?>  name="compativel" -->
       ...
       <div class="form-row">
        <div class="form-group col-md-6" align="start">
         ...
         <div class="form-group col-md-6" align="start">
           ...
           <input type="text" class="form-control" name="modo_consumo" value="<?php echo $arrayResult['modo_consumo']; ?>" id="ID_M_Consumo">
         </div>
       </div>          
