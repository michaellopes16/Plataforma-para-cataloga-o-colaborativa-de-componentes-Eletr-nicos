...
<!--   ==================== Início do corpo principal=======================================   -->
  ...
  <h5 class="modal-title mb-3 mt-4" align="center"><b>Gerenciar Baterias</b></h5>
      ...
      <div data-spy="scroll" class="container" >
          ...
          <div class="divScroll" data-spy="scroll" data-offse="0">
              ...
              <li class="list-group-item list-group-item-primary d-flex bd-highlight mb-3">
                ...
                <a href="TelaExibirBateria.php"  class="btn btn-link tamanhoBTNS mr-auto ml-2 mb-3 " align="center" ">  
                ...
                <div>
                <a href="TelaEditarBateria.php" class="btn btn-primary mt-2 mr-0 p-2 bd-highlight tamanhoBTNS p-2 bd-highlight"> 
...
<!--Fim da informações do Primeiro Item da Lista. Os outros deverão ser retirados e a geração deve vir a partir de um laço -->
          ...
          <a href="TelaInserirBateria.php" class="btn btn-primary p-2 bd-highlight mt-4 mb-3 ml-4">
