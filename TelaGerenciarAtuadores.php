...
{     
     ...
     #echo "Nome item atual: ".$itemAutal. "</br>";
       $exclusaoResult  = $fachada->excluirAtuador($itemAutal); 
       if ($exclusaoResult == 1) {
...
$arrayResult  = $fachada->exibirAtuadorPorCategoria($ID_ItemAtual);
        ...
        ?>
          ...
          <div class="row" align="start">
            ...
            <div class="col-md-6 mr-4 ml-5">
              <form method="POST" action="TelaExibirAtuador.php" data-toggle="validator" role="form" align="center" >
        ...
        <div class="modal fade" id="ID_Modal_Excluir" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true" >
             <div class="modal-dialog" role="document">
                  <div class="modal-content"  >
                      ...
                      <form method="POST" action="TelaGerenciarAtuadores.php" >
